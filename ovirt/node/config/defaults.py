...
#OVIRT_NODE_DEFAULTS_FILENAME = os.path.join(os.getcwd(),"ovirt/node/setup/ovirt_default.conf")
...
class NodeConfigFileSection(base.Base):
    ...
    @staticmethod
    def _map_and_update_defaults_decorator(func):
        def wrapper(self, *args, **kwargs):
            ...
            new_dict = dict((k,v) for k, v in new_cfg.items())
            self.defaults.update(new_dict, remove_empty=True)
