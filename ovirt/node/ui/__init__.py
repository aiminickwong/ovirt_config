...
class ErrorLabel(Element):
    """Represents a r/o label
    """

    def __init__(self, path, text):
        super(ErrorLabel, self).__init__(path)
        self.text(text)
...
#        super(ErrorLabel, self).__init__(path, text)
...
class AbstractUIBuilder(base.Base):
    ...
    def build(self, ui_element):
        ...
        builder_for_element = {
            ...
            ErrorLabel: self._build_errorlabel,
    ...
    def _build_errorlabel(self, ui_label):
        raise NotImplementedError
